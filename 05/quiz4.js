...
function downHanddler(e){
    ...
    function moveHanddler(e){
        element.style.top = (element.getBoundingClientRect().top + (e.clientY - preMouseY)) +"px";
        element.style.left = (element.getBoundingClientRect().left + (e.clientX - preMouseX)) +"px";
        preMouseX = e.clientX;
        preMouseY = e.clientY;
    }

    function upHanddler(e){
